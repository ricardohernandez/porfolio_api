...
TRUNCATE TABLE portfolio_projects RESTART IDENTITY CASCADE;
TRUNCATE TABLE sliders RESTART IDENTITY CASCADE;
TRUNCATE TABLE users RESTART IDENTITY CASCADE;
TRUNCATE TABLE skill_items RESTART IDENTITY CASCADE;
...
-- Insertar proyectos (DATOS REALES DE BD LOCAL)
...
-- Insertar skills (DATOS REALES - sin icons porque son muy largos)
...
-- Insertar skill items (DATOS REALES)
